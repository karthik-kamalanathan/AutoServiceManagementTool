<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndexPage.aspx.cs" Inherits="ASMT.UI.IndexPage" %>
            ...
            <div class="modal-content shadow">
                ...
                <div class="modal-body p-5 pt-0">
                    <form class="signInForm" runat="server">
                        ...
                        <div class="form-floating mb-3">
                            <asp:TextBox type="password" class="form-control" ID="txtPswd" placeholder="Password" name="password" runat="server" AutoCompleteType="Disabled" />
                            <label for="txtPswd">Password</label>
                        </div>
                        <asp:Button type="submit" class="w-100 mb-2 btn btn-lg btn-primary" runat="server" Text="Sign in" OnClick="signinClick" />
                    </form>
                </div>
