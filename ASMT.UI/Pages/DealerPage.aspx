    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
                    ...
                    <li><a class="dropdown-item" href="Pages/IndexPage.aspx">Sign out</a></li>
                </ul>
            </div>
        </div>
        <!-- Side Bar -->
        ...
        <div class="d-flex flex-column flex-fill">
            ...
            <div class="list-group list-group-flush border-bottom scrollarea">
                <a data-bs-toggle="modal" data-bs-target="#serviceDetailsModal" class="list-group-item list-group-item-action py-3 lh-tight" aria-current="true">
                ...
                <a data-bs-toggle="modal" data-bs-target="#serviceDetailsModal" class="list-group-item list-group-item-action py-3 lh-tight">
                    <div class="d-flex w-100 align-items-center justify-content-between">
                        <strong class="mb-1">List group item heading</strong>
